...
var signinPage = function () {
    function signinPage() {
        ...
        this.shouldHaveCode = function(value) {
            expect(this.code.getAttribute('value')).toEqual(value);
        };

        this.codeShouldBeVisible = function() {
            expect(this.code.isDisplayed()).toBeTruthy();
        };

        this.codeShouldNotBeVisible = function() {
            expect(this.code.isDisplayed()).toBeFalsy();
        };

        this.codeShouldBeEnabled = function() {
            expect(this.code.isEnabled()).toBeTruthy();
        };

        this.codeShouldNotBeEnabled = function() {
            expect(this.code.isEnabled()).toBeFalsy();
        };
        ...
        this.signUpLinkShouldBeVisible = function() {
            expect(this.signUpLink.isDisplayed()).toBeTruthy();
        };

        this.signUpLinkShouldNotBeVisible = function() {
            expect(this.signUpLink.isDisplayed()).toBeFalsy();
       };
    }
 };
